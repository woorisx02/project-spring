	...
	<div class="addr-container">
		<form action="/admin/member/reg-address" method="post">
			<div class="search-wrap">
				<input type="search" name="area3" placeholder="동 입력" class="input-frm input-mb input-addr" required>
				<button id="zip-searchBtn" type="submit" class="btn btn-register">우편번호 찾기</button>
		...
		<p class="addr-msg">※주소를 클릭하면 우편번호 입력폼과 주소 입력폼에 자동 입력됩니다.</p>
	</div>
</body>
</html>